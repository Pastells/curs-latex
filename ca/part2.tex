...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Title i Abstract}
\begin{frame}[fragile]{\insertsubsection}
\begin{itemize}{\small
\item Tell \LaTeX{} the \cmdbs{title} i \cmdbs{author} names in the preamble.
...
\begin{itemize}{\small
\item Just use \cmdbs{section} i \cmdbs{subsection}.
\item Can you guess what \cmdbs{section*} i \cmdbs{subsection*} do?
}\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Labels i Cross-References}
\begin{frame}[fragile]{\insertsubsection}
\begin{itemize}{\small
...
\vskip 3ex
makes the text bigger (12pt) i puts it into two columns.
...
\end{tabular}
\end{exampletwouptiny}
\item Use an ampersand \keystrokebftt{\&} to separate columns i a double backslash \keystrokebftt{\bs}\keystrokebftt{\bs} to start a new row (like in the \bftt{align*} environment that we saw in part 1).
\end{itemize}
\end{frame}
...
\item Use the \bftt{natbib} package\footnote{There is a new package with more
  ...
  \bftt{natbib}.} with \cmdbs{citet} i \cmdbs{citep}.
...
\begin{frame}[fragile]{\insertsubsection}
\begin{itemize}
\item Add the \cmdbs{tableofcontents} ordre to generate a table of contents
from the \cmdbs{section} ordres.
...
\item \bftt{todonotes}: comments i TODO management
...
\item You'll also have to know more about how \bftt{latex} i its related tools
