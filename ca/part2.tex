...
\subtitle{Part 2: Documents Estructurats}
...
\begin{itemize}
\item In Part 1, we learned about ordres i environments for typesetting text
and mathematics.
\item Now, we'll learn about ordres i environments for structuring
documents.
\item You can try out the new ordres in Overleaf:
\end{itemize}
\vskip 2em
\begin{center}
...
\begin{itemize}{\small
    \item Només cal fer servir \cmdbs{section} i \cmdbs{subsection} 
        (\textcolor{magenta}{\href{https://www.overleaf.com/learn/latex/Sections_and_chapters}{hi ha més nivells}})
...
\item Les dues serveixen per seccions, figures, taules, exemples de linguex \dots
}\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
...
\end{center}
Make your paper look like this one. Use \cmdbs{ref} i \cmdbs{eqref} to avoid
explicitly writing section i equation numbers into the text.
\end{block}
\vskip 2ex
\begin{center}
...
Cable  & 3   & 19.99   \\
\end{tabular}
\caption{\label{taula:items}Aww\dots.}
\end{table}
\end{exampletwouptiny}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Els separadors \keystrokebftt{|} dins l'argument fan línies verticals (millor evitar-les), \cmdbs{hline} fa línies horizontals. 
\begin{exampletwouptiny}
\begin{tabular}{|l|r|r|}
\hline
Item   & Qty & Unit \$ \\
...
\end{tabular}
\end{exampletwouptiny}
\item El paquet \keystrokebftt{booktabs} proporciona les ordres \cmdbs{toprule}, \cmdbs{midrule} i \cmdbs{bottomrule}. 
\begin{exampletwouptiny}
\begin{tabular}{lrr}
\toprule
Item   & Qty & Unit \$ \\
...
\begin{itemize}
    \item Feu servir el paquet \bftt{biblatex}\footnote{Hi ha un altre paquet (més vell) de referència, \bftt{natbib}. És possible que us el trobeu a alguna plantilla.}
 amb \cmdbs{cite} i \cmdbs{citetext}.
\item Reference \cmdbs{bibliography} at the end, i specify a \cmdbs{bibliographystyle}.
\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
  {bib-example.tex}
...
Add an image i a bibliography to the paper from the previous exercise.
...
\begin{frame}{\insertsubsection}
\begin{itemize}
\item \bftt{beamer}: per presentacion (com aquesta!)
...
\item \bftt{gchords}, \bftt{guitar}: guitar chords i tabulature
...
\begin{frame}{\insertsubsection}
\begin{itemize}
\item Per fer servir \LaTeX{} al vostre ordinador, us caldrà una \emph{distribution}: 
...
\begin{itemize}
    \item \textcolor{magenta}{\href{https://www.overleaf.com/read/rgxbsfvqsgbw\#ba04b9}{Breu transcripció fonètica}} --- amb tipa (comentat) o tipauni. 
    \item \textcolor{magenta}{\href{https://www.overleaf.com/read/mxysfjcnnppm\#294a25}{Treball de transcripció fonètica}} --- més extens que l'anterior, barreja de tipa i unicode.
    \item \textcolor{magenta}{\href{https://www.overleaf.com/read/sxkcdfrpmbcb\#10abd3}{Treball morfologia basca}} --- conté:
\begin{itemize}
    ...
    \item Una presentació amb beamer.
\end{itemize}
\item Finalment, us pot ser útil \textcolor{magenta}{\href{https://www.overleaf.com/read/vsdvmbzywdrn\#d43fce}{aquesta plantilla senzilla}}.
\end{itemize}
...
%{\scriptsize
%\begin{tabular}{ll}
%\cmdbs{begin}\bftt{\{document\}}\dots\cmdbs{end}\bftt{\{document\}} &
%  document environment \\
%\cmdbs{begin}\bftt{\{itemize\}}\dots\cmdbs{end}\bftt{\{itemize\}} &
%  itemized list environment \\
%\bftt{\$\dots\$}     & \emph{in-text} math environment \\
%\bftt{\$\$\dots\$\$} & \emph{displayed} math environment \\
%\cmdbs{begin}\bftt{\{equation\}}\dots\cmdbs{end}\bftt{\{equation\}} &
