...
\begin{frame}[fragile]{\insertsubsection}
\begin{itemize}{\small
\item Use \cmdbs{label} i \cmdbs{ref} for automatic numbering.
...
\item Aquest paquet admet JPG, JPEG, Supported graphics formats include JPEG, PNG i PDF (usually).
\end{itemize}
...
Cable  & 3   & 19.99   \\
\end{tabular}
\caption{\label{taula:items}Aww\ldots.}
\end{table}
\end{exampletwouptiny}
\end{itemize}
\end{frame}
...
\item \LaTeX{} formatejarà automàticament les cites en el format adequat (Science, APA, Chicago \ldots), tant dins al text com a l'apartat de referències.
\end{itemize}
\end{frame}
