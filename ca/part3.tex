...
\newordre{\alice}[1]{\todo[color=green!40]{#1}}
\newordre{\bob}[1]{\todo[color=purple!40]{#1}}
...
\begin{frame}[fragile]{\insertsection}
\begin{itemize}
\item The \cmdbs{todo} ordre from the \bftt{todonotes} package is great for
leaving notes to yourself i your collaborators.
\begin{exampletwouptiny}
\todo{add results}
\todo[color=blue!20]{fix method}
\end{exampletwouptiny}
\vskip 2ex
\item Pro Tip: define your own ordres with \cmdbs{newordre}
\begin{minted}[fontsize=\scriptsize,frame=single]{latex}
\newordre{\alice}[1]{\todo[color=green!40]{#1}}
\newordre{\bob}[1]{\todo[color=purple!40]{#1}}
\end{minted}
...
\begin{columns}
  \begin{column}{0.4\textwidth}
    ...
    \item There is also a handy \cmdbs{listoftodos} ordre.
    \end{itemize}
  \end{column}
  \begin{column}{0.6\textwidth}
