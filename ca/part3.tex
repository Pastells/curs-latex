...
\begin{itemize} 
    ...
    Per `arreglar-ho' afegiu \cmdbs{usepackage[T1]\{fontenc\}} al preàmbul.
...
\begin{itemize}
    \item És recomenable carregar el paquet \bftt{tipauni} (amb Lua\LaTeX{} o Xe\LaTeX) en comptes de \bftt{tipa}. Funciona exactament igual, però ens permetrà copiar els caràcters en Unicode.
...
\begin{itemize}
    \item Es pot canviar el tema (aspecte). La majoria de temes clàssics de \LaTeX{} són tirant a lletjos, però si es tria bé \href{https://rowannicholls.github.io/latex.html}{la combinació} poden quedar bé. 
    També s'en poden trobar de \href{https://github.com/martinbjeldbak/ultimate-beamer-theme-list?tab=readme-ov-file}{més moderns}. 
    Aquesta presentació fa servir el tema \textbf{metropolis}.\footnote{Segons quin tema trobeu en línia, és possible que no estigui instalat a Overleaf o la vostra instalació local. En aquest cas caldrà descarrear-se'l i posar-lo a la mateixa carpeta del projecte.}
...
\begin{itemize}
    ...
    \item \bftt{leipzig}: abreviatures glosses. 
