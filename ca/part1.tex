...
\begin{itemize}
\item Use caret \keystrokebftt{\^} for superscripts i underscore \keystrokebftt{\_} for subscripts.
\begin{exampletwouptiny}
$y = c_2 x^2 + c_1 x + c_0$
\end{exampletwouptiny}
\vskip 2ex
...
\item There are ordres for Greek letters i common notation.
\begin{exampletwouptiny}
$\mu = A e^{Q/RT}$
...
\item Use lots of different ordres.
...
with sections, cross references, figures, tables i bibliographies. See you
then!
\end{itemize}
\end{frame}
